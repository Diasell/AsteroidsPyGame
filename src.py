...
ship_image1     = pygame.image.load("ship.png")
ship_image2     = pygame.image.load("ship_thr.png")
missile_image   = pygame.image.load("shot1.png")
...
pbutton_image   = pygame.image.load("button_pressed1.png")
